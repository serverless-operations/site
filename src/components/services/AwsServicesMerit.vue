              ...
              <v-col cols="12" sm="10" md="8" lg="7">
                <div class="services-merit-title-container">
                  <p class="services-merit-header-text merit-text-anim">
                    AWSコアサーバーレスサービスを使って開発することのメリット
                  </p>
            ...
            <div class="service-merit-card-container">
              ...
              <div class="merit-card">
                ...
                <div class="merit-card-text">
                  ...
                  <p class="merit-card-text-desc">トラフィックのボリュームが増減しやすい場合においても、フルマネージドサービス型であるAWSコアサーバーレスサービス（AWS Lambda, Amazon API Gateway）及び Amazon DynamoDBを利⽤することで、トラフィックの変化に柔軟に対応できるシステムを構築できます。</p>
                </div>
              </div>
              ...
              <div class="merit-card">
                ...
                <div class="merit-card-text">
                  ...
                  <h3 class="merit-card-title">運⽤⼯数や⼈的コストを削減</h3>
                  <p class="merit-card-text-desc">インフラの運⽤⼯数も最⼩限に抑えることができるため、⼈的コストも削減して運⽤することが可能になります。インフラ運⽤の負担がなくなった分、少⼈数でもアプリ開発を集中して⾏えます。</p>
                </div>
              </div>
              ...
              <div class="merit-card">
                ...
                <div class="merit-card-text">
                  ...
                  <h3 class="merit-card-title">⼩さくはじめて、ビジネスの成⻑に伴いスケールしやすい</h3>
                  <p class="merit-card-text-desc">費⽤体系は「pay-as-you-go」と⾔われる従量課⾦で、ビジネスサイズに合わせて変動するため常に最適な状態を保つことができます。また従量課⾦であっても、ロードテストを⾏うことで事前に⽬安の費⽤を予測することも可能です。</p>
                </div>
              </div>
