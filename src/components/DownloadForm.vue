      ...
      <v-col cols="12" md="10" lg="8" class="p-top-contact--form">
        ...
        >
          <v-row no-gutters>
            ...
            <v-col cols="12" sm="8" md="7" lg="8">
              <v-text-field v-model="form.role" name="role"/>
            </v-col>
          </v-row>
          ...
          <v-row align="center" justify="end">
            <v-col cols="12" sm="8" md="7" lg="8">
              <p class="p-top-contact--note">
                <g-link to="/privacy-policy">個人情報保護方針
                </g-link>
...
const endPoint = "https://getform.io/f/634af40f-f69b-493e-8cd4-29e086b3c5c6" // 本番用
// const endPoint = "https://getform.io/f/a783f6b8-1a3a-42fc-a1d9-f88ffa75882d" // テスト用
